...
public class AdditionnResultActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_additionn_result);
        ...
        output_text.setText("The addition of " + user_value_1+ " and " + user_value_2 + " is");
